                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header" id="top">
                                    ...
                                    <div class="page-breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Event Table</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Edit event table</li>
                                            </ol>
                                            </ol>
                                        </nav>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="section-block" id="basicform">
                                    <h3 class="section-title">Edit Event Data</h3>
